...
def export_comparative_excel(ctrl_u: UnmanagedController, ctrl_m: ManagedController, fn="OutputExcel/ev_sarj_karsilastirma_raporu.xlsx"):
...
def export_multi_controller_excel(all_controllers: list, fn="OutputExcel/ev_coklu_kontrolcu_raporu.xlsx"):
